...
def get_args():
    ...
    parser.add_argument(
        '--graph-file',
        type=str,
        default="MAES/graphs/wm.txt",
        help='file containing the population strucuture (default: MAES/graphs/wm.txt)'
    )
    parser.add_argument(
        '--sol-pool-size',
        type=int,
        default=5,
        help='size of the solution pool (default: 5)'
    )
    parser.add_argument(
        '--max-clones',
        type=int,
        default=5,
        help='maximum number of clones in solution pool <= sol-pool-size (default: 5)'
    )
    parser.add_argument(
        '--select-period',
        type=int,
        default=10,
        help='number of epochs between two selection phases (default: 10)'
    )
    parser.add_argument(
        '--eval-period',
        type=Optional[int],
        default=None,
        help='number of epochs between two evaluation phases (default: None, no evaluation)'
    )
    parser.add_argument(
        '--n-gens',
        type=int,
        default=10,
        help='number of generations of evolutionary algorithm (default: 10)'
    )
